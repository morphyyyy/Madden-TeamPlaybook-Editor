...
namespace Madden.TeamPlaybook
{
    ...
    public class SETG
    {
        ...
        public static List<SETG> GetSETG(int filter = 0, int DBIndex = 0)
        {
            ...
            for (int i = 0; i < TableProps.RecordCount; i++)
            {
                if (filter != 0 && (int)(UInt32)TDB.TDBFieldGetValueAsInteger(DBIndex, TDB.StrReverse("SETG"), TDB.StrReverse("SETP"), i) == filter)
                {
                    ...
                    {
                        rec = i,
                        setg = (int)(UInt32)TDB.TDBFieldGetValueAsInteger(DBIndex, TDB.StrReverse("SETG"), TDB.StrReverse("SETG"), i),
        ...
        public static void SetSETG(List<SETG> SETG, int DBIndex = 0)
        {
            ...
            {
                TDB.TDBFieldSetValueAsInteger(DBIndex, TDB.StrReverse("SETG"), TDB.StrReverse("SETG"), item.rec, item.setg);
        ...
        {
            return SETG.OrderBy(s => s.setg).Cast<SETG>().ToList();
        }
    }
}
